...
public class SupplierAccount extends javax.swing.JFrame {
    ...
    private static SupplierDashboard dashboard;

    public SupplierAccount(SupplierDashboard dashboard) {
        initComponents();
        init();
        SupplierAccount.dashboard = dashboard;
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 50, -1, 20));

        jLabel5.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel5.setText("Phone");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 110, 40, 20));
    ...
    private void init() {
        ...
        info = supplier.getSuppliersInfo(sId);
        setValue();
    }
    ...
    private void setValue() {
        ...
        jPasswordField1.setText(info[3]);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SupplierAccount(dashboard).setVisible(true);
            }
        });
    }
